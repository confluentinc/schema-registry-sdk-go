...
`func (o *ExporterInfo) SetKekRenameFormat(v string)`

SetKekRenameFormat sets KekRenameFormat field to given value.

### HasKekRenameFormat

`func (o *ExporterInfo) HasKekRenameFormat() bool`
