...
## Mocking
We use a custom fork of the openapi generator to generate interfaces that can be used to generate mocks. Once the interfaces are
updated, use the `make mock` command to generate new mocks
...
*DefaultApi* | [**TestCompatabilityBySubjectName**](docs/DefaultApi.md#testcompatabilitybysubjectname) | **Post** /compatibility/subjects/{subject}/versions/{version} | Test input schema against a particular version of a subject&#39;s schema for compatibility.
